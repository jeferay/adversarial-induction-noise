ATTACK_TYPE=sample_assign
STEP_SIZE=2
LABEL_ASSIGN=random
DEVICE=4
python3 perturbation.py --config_path             ../configs/cifar10                \
                        --device                  ${DEVICE}                           \
                        --exp_name                ../experiments/${ATTACK_TYPE}/samplewise/cifar10/at_pretrain_epsilon32_${LABEL_ASSIGN}_stepsize${STEP_SIZE}/perturbation \
                        ...
                        --random_start  --pretrain --load_model \
                        &
