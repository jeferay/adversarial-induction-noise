...
python3 perturbation.py --config_path             ../configs/cifar10                \
                        --device                   ${DEVICE}                \
                        --exp_name                ../_experiments/mada/samplewise/cifar10/at_from_scratch_epsilon32_${LABEL_ASSIGN}_batch128_rs_stepsize${STEP_SIZE}_trainstep${TRAIN_STEP}/perturbation \
