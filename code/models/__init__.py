...
from . import DenseNet, ResNet, ToyModel,inception_resnet_v1, Vgg, MobileNet_v2
...
mlconfig.register(Vgg.vgg11)
mlconfig.register(Vgg.vgg11_bn)
mlconfig.register(MobileNet_v2.mobilenet_v2)
